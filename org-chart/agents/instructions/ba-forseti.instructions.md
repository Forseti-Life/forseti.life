...
1. Search the dungeoncrawler module for the feature keyword:
   ```bash
   grep -rl "<feature-keyword>" /home/keithaumiller/forseti.life/sites/dungeoncrawler/web/modules/custom/dungeoncrawler_content/src/
   ```
...
When formal requirements docs exist for a module (e.g., `/home/keithaumiller/forseti.life/docs/jobhunter/requirements/`):
...
- Draft the full REQ text directly in the relevant requirements doc (`/home/keithaumiller/forseti.life/docs/jobhunter/requirements/jh-NN-*.md`) within the same improvement round.

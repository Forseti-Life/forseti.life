...
### Deployment and Sync Governance

- `docs/technical/DEPLOYMENT.md` — production deployment policy (manual promotion)
- `docs/technical/DEVELOPMENT_SYNC_WORKFLOW.md` — dual-environment conflict-safe development workflow

# PF2E Guns and Gears — Chapter 1: Gears Characters (p.10)
...
> "Chapter 1: Gears Characters (p.10) defines mechanics and data constraints that must be represented in the implementation."

# PF2E Secrets of Magic — Chapter 1: Essentials of Magic (p.6)
...
> "Chapter 1: Essentials of Magic (p.6) defines mechanics and data constraints that must be represented in the implementation."

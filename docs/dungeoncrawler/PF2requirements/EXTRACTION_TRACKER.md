...
| 3 | Chapter 3: Classes (p.66) | `references/core-ch03-classes.md` | `[ ]` |
...
| 11 | Chapter 11: Crafting & Treasure (p.530) | `references/core-ch11-crafting-treasure.md` | `[ ]` |
...
| # | Chapter | File | Status |
|---|---------|------|--------|
| 1 | Chapter 1: Ancestries & Backgrounds (p.6) | `references/apg-ch01-ancestries-backgrounds.md` | `[ ]` |
| 2 | Chapter 2: Classes (p.52) | `references/apg-ch02-classes.md` | `[ ]` |
| 3 | Chapter 3: Archetypes (p.148) | `references/apg-ch03-archetypes.md` | `[ ]` |
| 4 | Chapter 4: (Content beyond extracted TOC) | `references/apg-ch04.md` | `[ ]` |

...
| DCT-0125 | Improve CharacterApiControllerTest request realism by submitting representative JSON payloads and asserting explicit API contract outcomes | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0054 audit; API tests rely on permissive non-404/405 checks and minimal request data, reducing defect-detection value. |
| DCT-0126 | Consolidate overlapping character creation/list controller functional tests and add step-level behavior assertions | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0055/DCT-0056/DCT-0057 audits; route access checks are duplicated across files with limited assertions on workflow/state behavior. |
| DCT-0127 | Replace permissive “not 405” route smoke checks in character state/view tests with contract-level assertions using seeded entities | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0058/DCT-0059 audits; tests currently pass on multiple non-target outcomes and provide weak regression signal. |
...
| DCT-0132 | Replace brittle full-markup `responseContains()` assertions in HexMapUiStageGateTest with stable selector/semantic checks | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0068 audit; tests assert exact HTML fragments (classes/styles/attribute order), creating high false-failure risk from harmless markup changes. |
| DCT-0133 | Extract shared campaign setup/request helpers in EntityLifecycle functional tests to reduce duplication and static service coupling | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0074 audit; repeated campaign bootstrap code and direct static service/database calls increase maintenance overhead and inconsistency risk. |
| DCT-0134 | Replace permissive `statusCodeNotEquals(404|405)` API route assertions with explicit method/auth/contract checks | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0076 audit; many route tests pass on broad non-target outcomes and miss concrete API behavior regressions. |
| DCT-0135 | Replace fixture-missing “positive” route assertions (`statusCodeNotEquals(200)`) with seeded-entity campaign/character route tests | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0077/DCT-0078 audits; tests currently pass when required entities are absent, masking real route-contract regressions. |

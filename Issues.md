...
| ID | Title | Current Status | Owner | Created | Last Updated | Notes |
|---|---|---|---|---|---|---|
| DCT-0122 | Extract shared campaign fixture/setup helpers for functional campaign-state tests to reduce duplication and static service calls | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0049/DCT-0050 audits; tests duplicate campaign insert scaffolding and repeatedly use `\Drupal::...` lookups inside test methods. |
| DCT-0123 | Implement or quarantine incomplete CharacterCreationWorkflowTest coverage currently blocked by `markTestIncomplete()` placeholders | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0051 audit; workflow suite is scaffolded but non-executing, creating false confidence in critical path coverage. |
...
| DCT-0131 | Remove redundant duplicate assertions in simple controller smoke tests and favor distinct behavior checks | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0064/DCT-0065 audits; several tests repeat equivalent status assertions instead of validating unique outcomes. |
...
| DCT-0136 | Tighten PublicRoutesTest method semantics and reduce overlap with controller-level smoke tests | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0080 audit; assertions like POST `/home` expecting 200 and duplicated route text checks provide limited regression value and ambiguous intent. |
| DCT-0137 | Remove stale TODO/coverage-target placeholders and align unit-test/testing-doc narratives with actual implemented scope | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0082/DCT-0083/DCT-0085/DCT-0086 audits; multiple files still advertise “TODO implement” or planned-only language despite partial implementations, causing documentation drift. |

...
| ID | Title | Current Status | Owner | Created | Last Updated | Notes |
|---|---|---|---|---|---|---|
| DCT-0124 | Strengthen controller functional tests beyond route/status smoke checks with response-structure and domain-state assertions | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0052/DCT-0053 audits; current tests mostly validate status/text presence and miss deeper behavior verification. |
| DCT-0128 | Reframe CombatActionControllerTest around actual routed behavior or move to targeted unit/kernel coverage | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0060 audit; current assertions validate class existence and known-404 paths, providing limited functional confidence. |
| DCT-0129 | Replace route-less combat controller class-existence tests with behavior-driven coverage tied to actual routes or service contracts | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0061/DCT-0062 audits; assertions currently validate class presence + known 404s and provide low regression protection. |
| DCT-0130 | Strengthen CombatEncounterApiController functional tests with representative payloads, seeded encounter state, and response-schema assertions | Open | Unassigned | 2026-02-16 | 2026-02-16 | Discovered during DCT-0063 audit; tests mostly assert non-404/405 outcomes without validating contract correctness or state transitions. |

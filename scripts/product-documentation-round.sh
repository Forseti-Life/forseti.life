...
for agent in $pm_agents; do
  ...
  case "$agent" in
    pm-forseti) dest="/home/keithaumiller/forseti.life/docs/product/job-hunter/README.md" ;;
    pm-dungeoncrawler) dest="/home/keithaumiller/forseti.life/docs/dungeoncrawler/product-overview.md" ;;
    pm-stlouisintegration) dest="/home/keithaumiller/forseti.life/docs/product/stlouisintegration/README.md" ;;
    pm-theoryofconspiracies) dest="/home/keithaumiller/forseti.life/docs/product/theoryofconspiracies/README.md" ;;
    pm-thetruthperspective) dest="/home/keithaumiller/forseti.life/docs/product/thetruthperspective/README.md" ;;
    pm-forseti-agent-tracker) dest="/home/keithaumiller/forseti.life/docs/product/agent-management/copilot-agent-tracker.md" ;;
  esac
...
- command: |
    ...
    2) Generate (or update) product documentation using this template:
       - /home/keithaumiller/copilot-sessions-hq/templates/product-documentation.md

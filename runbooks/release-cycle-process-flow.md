...
**Owner:** Any role (intake), coordinated by PM/CEO
...
**Owner:** PM(s) (coordination) + CEO (tie-breakers)
...
- PM escalation rule:
  - If there are **3 unclean releases in a row** for a product/site, PM escalates to CEO for intervention.
...
**Handoff:** after release completion, PM and CEO run a post-release process review, record gaps, and queue follow-through items to owning seats.

**SoT locations:**
- Lessons/proposals: `knowledgebase/lessons/`, `knowledgebase/proposals/`
- Org-wide/role/seat instructions: `org-chart/*`
- Post-release PM/CEO process review dispatch: `scripts/improvement-round.sh` (and associated queues)

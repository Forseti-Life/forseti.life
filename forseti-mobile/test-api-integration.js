...
const testApiIntegration = async () => {
  ...
  const baseUrl = 'http://127.0.0.1'; // St. Louis Integration site with Forseti module (port 80)
  ...
  try {
    ...
    const response = await axios.post(
      `${baseUrl}/oauth/token`,
      'grant_type=password&client_id=forseti_mobile&username=admin&password=admin',
      {
        headers: {

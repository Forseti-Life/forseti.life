...
Generated: 2026-02-20T11:39:38-05:00

| Work item | Website | Module | Status | Priority | PM | Dev | QA |
|----------|---------|--------|--------|----------|----|-----|----|
| forseti-copilot-agent-tracker | forseti.life | copilot_agent_tracker | in_progress | P1 | pm-forseti-agent-tracker | dev-forseti-agent-tracker | qa-forseti-agent-tracker |
| forseti-jobhunter-profile | forseti.life | job_hunter | in_progress | P0 | pm-forseti | dev-forseti | qa-forseti |

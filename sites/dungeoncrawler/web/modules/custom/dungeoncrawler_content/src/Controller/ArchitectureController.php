  ...
  public function index(): array {
    ...
    $architecture_map = [
      ...
      [
        ...
        'entry_route' => Url::fromRoute('dungeoncrawler_content.architecture')->toString(),
        'source_of_truth' => $this->t('Architecture pages + feature implementation notes'),
        'flow' => $this->t('Architecture governance and review'),
        'sequence' => $this->t('/architecture → /architecture/controllers → /architecture/encounter-ai-integration → feature index sync'),
        'controllers_apis' => $this->t('ArchitectureController (hub + HQ feature index), ControllerArchitectureController (backend mapping), EncounterAiIntegrationController (phase status/safeguards/AI orchestration metrics).'),
        ...
        'drill_label' => $this->t('Controller architecture map'),
        'drill_url' => Url::fromRoute('dungeoncrawler_content.controller_architecture')->toString(),
        'drill_description' => $this->t('Backend architecture reference including encounter AI integration boundaries.'),
      ],
    ];

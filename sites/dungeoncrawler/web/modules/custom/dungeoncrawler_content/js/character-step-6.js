      ...
      once('step6-init', SELECTORS.FORM, context).forEach((element) => {
        ...
        once('step6-submit', SELECTORS.FORM, context).forEach((formEl) => {
          $(formEl).on('submit', function(e) {
            ...
            // Validate deity, age, and gender fields if present (all optional except deity for clerics/champions)
            // Schema validation happens server-side via CharacterCreationStepController

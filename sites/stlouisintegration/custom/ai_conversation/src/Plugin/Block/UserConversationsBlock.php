...
class UserConversationsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if (empty($conversations)) {
      $build = [
        '#type' => 'markup',
        '#markup' => '<div class="user-conversations-empty">' . $this->t('No previous conversations found. <a href="@create_url">Visit The Truth Perspective</a>?', [
          '@create_url' => 'https://thetruthperspective.org'
        ]) . '</div>',
        '#attached' => [
          'library' => [

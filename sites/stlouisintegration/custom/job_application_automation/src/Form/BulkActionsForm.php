...
class BulkActionsForm extends FormBase {
  ...
  public function getFormId() {
    return 'job_application_automation_bulk_actions';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // Log the action
    \Drupal::logger('job_application_automation')->info('Bulk action "@action" performed on @count applications by user @user.', [
      '@action' => $action,
      '@count' => $count,

...
class BulkCompanyImportForm extends FormBase {
  ...
  public function getFormId() {
    return 'job_application_automation_bulk_company_import';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['actions']['cancel'] = [
      '#type' => 'link',
      '#title' => $this->t('Cancel'),
      '#url' => \Drupal\Core\Url::fromRoute('job_application_automation.dashboard'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($companies as $company_name) {
      try {
        ...
        $error_count++;
        \Drupal::logger('job_application_automation')->error('Failed to create company "@company": @error', [
    ...
    $form_state->setRedirect('job_application_automation.dashboard');
  }

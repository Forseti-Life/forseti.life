...
class JobApplicationForm extends FormBase {
  ...
  public function getFormId() {
    return 'job_application_automation_job_application_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['actions']['cancel'] = [
      '#type' => 'link',
      '#title' => $this->t('Cancel'),
      '#url' => \Drupal\Core\Url::fromRoute('job_application_automation.home'),
      '#attributes' => [
        'class' => ['button'],
      ],
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::logger('job_application_automation')->info(
    ...
    $form_state->setRedirect('job_application_automation.home');
  }

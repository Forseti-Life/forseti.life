...
1. Upload module to `/web/modules/custom/job_application_automation/`
...
drush en job_application_automation -y
...
composer require drupal/job_application_automation
drush en job_application_automation -y
```
...
drush pm:list | grep job_application_automation

# Manually trigger installation hooks if needed
drush php:eval "job_application_automation_install();"
```

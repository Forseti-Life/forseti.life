...
namespace Drupal\resume_tailoring;

use Drupal\Core\Logger\LoggerChannelFactoryInterface;

class ResumeTailoringManager {
  ...
  /**
   * Constructs a new ResumeTailoringManager object.
   */
  public function __construct(LoggerChannelFactoryInterface $logger_factory) {
    $this->logger = $logger_factory->get('resume_tailoring');
  }

...
class ForsetiPagesController extends ControllerBase {
  ...
  public function dimensionComputationalResources() {
    return $this->buildDimensionPage(
      ...
      $this->buildComputationalResourcesLevels()
    );
  }
  ...
  public function dimensionFinancialCapital() {
    return $this->buildDimensionPage(
      ...
      $this->buildFinancialCapitalLevels()
    );
  }
  ...
  public function dimensionInfrastructureAccess() {
    return $this->buildDimensionPage(
      ...
      $this->buildInfrastructureAccessLevels()
    );
  }
  ...
  public function dimensionEnergyResources() {
    return $this->buildDimensionPage(
      ...
      $this->buildEnergyResourcesLevels()
    );
  }
  ...
  public function dimensionTimeAllocation() {
    return $this->buildDimensionPage(
      ...
      $this->buildTimeAllocationLevels()
    );
  }
  ...
  public function dimensionTrustNetworkDepth() {
    return $this->buildDimensionPage(
      ...
      $this->buildTrustNetworkDepthLevels()
    );
  }
  ...
  public function dimensionDependencyRelationships() {
    return $this->buildDimensionPage(
      ...
      $this->buildDependencyRelationshipsLevels()
    );
  }
  ...
  public function dimensionGatekeepingPower() {
    return $this->buildDimensionPage(
      ...
      $this->buildGatekeepingPowerLevels()
    );
  }
  ...
  public function dimensionInfluenceReach() {
    return $this->buildDimensionPage(
      ...
      $this->buildInfluenceReachLevels()
    );
  }
  ...
  public function dimensionReputationCapital() {
    return $this->buildDimensionPage(
      ...
      $this->buildReputationCapitalLevels()
    );
  }
  ...
  public function dimensionMobilizationCapability() {
    return $this->buildDimensionPage(
      ...
      $this->buildMobilizationCapabilityLevels()
    );
  }
  ...
  public function dimensionLegalAuthorization() {
    return $this->buildDimensionPage(
      ...
      $this->buildLegalAuthorizationLevels()
    );
  }
  ...
  public function dimensionDecisionMakingScope() {
    return $this->buildDimensionPage(
      ...
      $this->buildDecisionMakingScopeLevels()
    );
  }
  ...
  public function dimensionBudgetAuthority() {
    return $this->buildDimensionPage(
      ...
      $this->buildBudgetAuthorityLevels()
    );
  }
  ...
  public function dimensionJurisdictionalReach() {
    return $this->buildDimensionPage(
      ...
      $this->buildJurisdictionalReachLevels()
    );
  }
  ...
  public function dimensionEnforcementPower() {
    return $this->buildDimensionPage(
      ...
      $this->buildEnforcementPowerLevels()
    );
  }
  ...
  public function dimensionMoralAuthority() {
    return $this->buildDimensionPage(
      ...
      $this->buildMoralAuthorityLevels()
    );
  }
  ...
  private function buildIntroContent() {
    return [
      ...
      'paragraphs' => [
        ...
        $this->t('Power Level 0 represents zero capability - no access, no processing, nothing. Each ascending level adds capabilities: from basic UI (Level 1), through filtered content (Level 2), personal/commercial (Level 3), operational/tactical (Level 4), specialized/ideological (Level 5), domain-specific professional (Level 6), multi-domain academic (Level 7), cross-institutional scientific (Level 8), and finally approaching omniscient universal (Level 9, ∞).'),
  ...
  /**
   * Build power categories framework.
   */
  private function buildPowerCategories() {
    return [
      [
        ...
        'icon' => 'database',
        'description' => $this->t('The foundation of power: what you can know that others cannot. Measures ability to access, process, and validate information across domains, time, sources, and sensitivity levels.'),
        'dimensions' => 6,
        'status' => 'complete',
        'examples' => $this->t('Intelligence agencies with classified access, research institutions with extensive archives, global news organizations with worldwide correspondents.'),
      ],
      [
        'id' => 'resource-control',
        'name' => $this->t('Resource Control'),
        'icon' => 'coins',
        'description' => $this->t('Material power: computational, financial, and infrastructure resources available to act. Having perfect knowledge means nothing without resources to execute.'),
        'dimensions' => 6,
        'status' => 'complete',
        'examples' => $this->t('Tech giants with massive compute clusters, sovereign wealth funds, multinational corporations with global supply chains.'),
      ],
      [
        'id' => 'authority',
        'name' => $this->t('Authority & Permission'),
        'icon' => 'gavel',
        'description' => $this->t('Legitimacy to act: legal rights, social permissions, and institutional backing. What you are allowed to do regardless of capability.'),
        'dimensions' => 6,
        'status' => 'complete',
        'examples' => $this->t('Government regulators with enforcement power, corporate executives with decision authority, certified professionals with practice rights, military commanders with jurisdictional reach, moral leaders with ethical credibility.'),
      ],
      [
        'id' => 'network-position',
        'name' => $this->t('Network Position'),
        'icon' => 'network-wired',
        'description' => $this->t('Social power: trust networks, dependencies, and influence pathways that amplify capability. Who you can mobilize matters as much as what you know.'),
        'dimensions' => 6,
        'status' => 'complete',
        'examples' => $this->t('Social media influencers with millions of followers, central banks affecting global markets, platforms controlling critical infrastructure.'),
      ],
      [
        'id' => 'synthesis',
        'name' => $this->t('Synthesis & Application'),
        'icon' => 'brain',
        'description' => $this->t('Cognitive power: ability to connect information across domains and execute strategically. Quality of thinking and speed of action.'),
        'dimensions' => 1,
        'status' => 'partial',
        'examples' => $this->t('Strategic military commanders, exceptional scientists making breakthrough connections, master negotiators reading complex situations.'),
      ],
    ];
  }
    ...
    return [
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 1, 'value' => $this->t('FAQ-Level')],
          ...
          'authority' => ['level' => 1, 'value' => $this->t('Query Approved')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 2, 'value' => $this->t('Public Vetted')],
          ...
          'authority' => ['level' => 2, 'value' => $this->t('Public Read')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 3, 'value' => $this->t('Personal')],
          ...
          'authority' => ['level' => 3, 'value' => $this->t('User Data Read')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 4, 'value' => $this->t('Task Data')],
          ...
          'authority' => ['level' => 4, 'value' => $this->t('Local Analysis')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 5, 'value' => $this->t('Filtered Public')],
          ...
          'authority' => ['level' => 5, 'value' => $this->t('Alert/Coordinate')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 6, 'value' => $this->t('Internal Access')],
          ...
          'authority' => ['level' => 6, 'value' => $this->t('Domain Execute')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 7, 'value' => $this->t('Moderate Classification')],
          ...
          'authority' => ['level' => 7, 'value' => $this->t('Recommend/Analyze')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 8, 'value' => $this->t('High Classification')],
          ...
          'authority' => ['level' => 8, 'value' => $this->t('Multi-Domain Execute')],
      ...
      [
        ...
        'dimensions' => [
          ...
          'classification' => ['level' => 9, 'value' => $this->t('Approaching Omniscient Access (∞)')],
          ...
          'authority' => ['level' => 9, 'value' => $this->t('Approaching Omnipotent (∞)')],
  ...
  private function buildRestrictionLevels() {
    return [
      ...
      ['level' => 6, 'badge' => 'bg-info', 'label' => 'RESTRICTION 6', 'name' => $this->t('Resource Constrained'), 'title' => $this->t('Bandwidth Limited'), 'description' => $this->t('Filtered by available computational/data resources rather than ideology. Limited by capacity, not values.'), 'example' => $this->t('Older AI models like GPT-3.5 with token limits, municipal government systems with limited server capacity, small hospital networks with bandwidth constraints, or open-source projects running on limited infrastructure (e.g., smaller Mastodon instances).')],
  ...
  /**
   * Get Agent Power Framework content.
   */
  ...
  public function evaluationMatrix() {
    $entities = $this->buildEntityEvaluations();
    ...
    foreach ($entities as $entity) {
      $content .= '<tr>';
      $content .= '<td class="entity-name">' . $entity['name'] . '</td>';
      $content .= '<td class="entity-type">' . $entity['type'] . '</td>';
      $content .= '<td class="score">' . $entity['technical'] . '</td>';
      $content .= '<td class="score">' . $entity['governance'] . '</td>';
      $content .= '<td class="score">' . $entity['transparency'] . '</td>';
      $content .= '<td class="score">' . $entity['safety'] . '</td>';
      $content .= '<td class="score">' . $entity['ethics'] . '</td>';
      $content .= '<td class="score">' . $entity['implementation'] . '</td>';
      $content .= '<td class="score">' . $entity['innovation'] . '</td>';
      $content .= '<td class="score">' . $entity['impact'] . '</td>';
      $content .= '<td class="score overall">' . $entity['overall'] . '</td>';
      $content .= '</tr>';
    }
    ...
    return [
      '#markup' => $content,
      '#attached' => [
        'library' => ['forseti_safety_content/forseti_pages'],
      ],
    ];
  }

  /**
   * Build entity evaluations data.
   */
  private function buildEntityEvaluations() {
    return [
      ...
      ['name' => 'AlgorithmWatch', 'type' => 'Non-Profit', 'technical' => 73, 'governance' => 87, 'transparency' => 95, 'safety' => 83, 'ethics' => 92, 'implementation' => 71, 'innovation' => 72, 'impact' => 76, 'overall' => 81],
    ];
  }
  ...
  public function allDimensions() {
    $dimensions = $this->buildAllDimensionsList();
    ...
    foreach ($dimensions as $category => $items) {
      ...
      $content .= '<ul class="dimension-list">';
      
      foreach ($items as $dimension) {
        $content .= '<li class="dimension-item">';
        $content .= '<strong>' . $dimension['name'] . '</strong>';
        $content .= '<p class="dimension-description">' . $dimension['description'] . '</p>';
        $content .= '</li>';
      }
  ...
  public function informationAccess() {
    ...
    $dimensions = [
      ['id' => 'scope', 'name' => 'Scope & Breadth', 'description' => 'Breadth of knowledge domains accessible - from universal all-domain access to narrow single-task context.', 'icon' => 'globe'],
      ['id' => 'classification', 'name' => 'Classification Access', 'description' => 'Sensitivity level of accessible information - from top secret to basic public FAQs only.', 'icon' => 'lock'],
      ['id' => 'temporal', 'name' => 'Temporal Reach', 'description' => 'Access to historical data and real-time feeds - from complete timeline to static snapshot.', 'icon' => 'clock'],
      ['id' => 'sources', 'name' => 'Source Diversity', 'description' => 'Range and diversity of information sources - from all sources globally to single internal knowledge base.', 'icon' => 'stream'],
      ['id' => 'granularity', 'name' => 'Data Granularity', 'description' => 'Level of detail accessible - from atomic individual records to general concepts only.', 'icon' => 'microscope'],
      ['id' => 'verification', 'name' => 'Data Verification', 'description' => 'Level of information validation - from raw + all verification levels to pre-written only.', 'icon' => 'check-circle'],
    ];
    
    $content .= '<div class="row row-cols-1 row-cols-md-2 g-4 mb-5">';
    foreach ($dimensions as $dim) {
      $content .= '<div class="col">';
      $content .= '<a href="/agent-power-framework/' . $dim['id'] . '" class="text-decoration-none">';
      $content .= '<div class="card card-forseti h-100 p-4 hover-lift">';
      $content .= '<h4 class="text-cyan mb-3"><i class="fas fa-' . $dim['icon'] . ' me-2"></i>' . $dim['name'] . '</h4>';
      $content .= '<p class="text-muted-light mb-0">' . $dim['description'] . '</p>';
      $content .= '</div></a></div>';
    }
    $content .= '</div>';
  ...
  public function resourceControl() {
    ...
    $dimensions = [
      ['id' => 'computational-resources', 'name' => 'Computational Resources', 'description' => 'Processing power, memory, storage, and GPU access for training and inference.', 'icon' => 'microchip'],
      ['id' => 'financial-capital', 'name' => 'Financial Capital', 'description' => 'Budget availability for operations, acquisitions, and strategic initiatives.', 'icon' => 'dollar-sign'],
      ['id' => 'infrastructure-access', 'name' => 'Infrastructure Access', 'description' => 'Physical facilities, data centers, network bandwidth, and technological platforms.', 'icon' => 'server'],
      ['id' => 'human-capital', 'name' => 'Human Capital', 'description' => 'Workforce expertise, labor availability, and talent quality.', 'icon' => 'users'],
      ['id' => 'energy-resources', 'name' => 'Energy Resources', 'description' => 'Power availability and efficiency for computation and operations.', 'icon' => 'bolt'],
      ['id' => 'time-allocation', 'name' => 'Time Allocation', 'description' => 'Attention, priority, and temporal resources for execution.', 'icon' => 'hourglass-half'],
    ];
  ...
  public function networkPosition() {
    ...
    $dimensions = [
      ['id' => 'trust-network-depth', 'name' => 'Trust Network Depth', 'description' => 'Quality and strength of trusted relationships that enable coordination and cooperation.', 'icon' => 'handshake'],
      ['id' => 'dependency-relationships', 'name' => 'Dependency Relationships', 'description' => 'How many entities depend on this entity for critical functions or resources.', 'icon' => 'link'],
      ['id' => 'gatekeeping-power', 'name' => 'Gatekeeping Power', 'description' => 'Control over critical pathways, approvals, or bottlenecks in systems or processes.', 'icon' => 'door-open'],
      ['id' => 'influence-reach', 'name' => 'Influence Reach', 'description' => 'Ability to shape opinions, decisions, and behaviors across networks.', 'icon' => 'bullhorn'],
      ['id' => 'reputation-capital', 'name' => 'Reputation Capital', 'description' => 'Accumulated credibility, legitimacy, and social proof that enables action.', 'icon' => 'award'],
      ['id' => 'mobilization-capability', 'name' => 'Mobilization Capability', 'description' => 'Speed and scale at which resources and people can be coordinated for action.', 'icon' => 'users-cog'],
    ];
  ...
  public function authorityCategory() {
    ...
    $dimensions = [
      [
        'id' => 'legal-authorization',
        'name' => 'Legal Authorization',
        'description' => 'Licensed, certified, or legally permitted activities and professional standing. From no licenses to sovereign immunity.',
        'icon' => 'balance-scale',
      ],
      [
        'id' => 'decision-making-scope',
        'name' => 'Decision-Making Scope',
        'description' => 'Range and significance of decisions the entity is authorized to make. From personal choices to absolute decision power.',
        'icon' => 'sitemap',
      ],
      [
        'id' => 'budget-authority',
        'name' => 'Budget Authority',
        'description' => 'Financial resources the entity can approve and commit without additional authorization. From zero spending power to unlimited budgets.',
        'icon' => 'dollar-sign',
      ],
      [
        'id' => 'jurisdictional-reach',
        'name' => 'Jurisdictional Reach',
        'description' => 'Geographic and organizational scope where authority applies. From personal space to universal jurisdiction.',
        'icon' => 'map-marked',
      ],
      [
        'id' => 'enforcement-power',
        'name' => 'Enforcement Power',
        'description' => 'Ability to compel compliance and impose consequences for violations. From recommendations to military force.',
        'icon' => 'shield-alt',
      ],
      [
        'id' => 'moral-authority',
        'name' => 'Moral Authority',
        'description' => 'Ethical legitimacy, social credibility, and moral standing that enables action. From discredited to approaching divine moral wisdom.',
        'icon' => 'hands-helping',
      ],
    ];
  ...
  public function synthesisCategory() {
    ...
    $dimension = [
      ...
      'description' => 'Ability to connect information across domains - from universal connections to no synthesis capability. The cognitive power to see patterns, make novel connections, and generate strategic insights.',
      'icon' => 'brain',
      'scale_note' => 'Level 0 (No Connection) to Level 9 (Universal Synthesis - ∞)',
      'examples' => [
        'Level 9: Universal synthesis - makes connections across all domains, sees emergent patterns invisible to others',
        'Level 7: Multi-domain academic - connects insights across multiple fields, identifies non-obvious relationships',
        'Level 4: Specialized tactical - makes connections within narrow domains, sees operational patterns',
        'Level 1: Basic responses - retrieves information but makes no novel connections',
        'Level 0: No synthesis - cannot connect information even when present',
      ],
    ];
  ...
  /**
   * Build all dimensions list data.
   */

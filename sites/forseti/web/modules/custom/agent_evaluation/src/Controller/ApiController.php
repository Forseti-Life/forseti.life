...
class ApiController extends ControllerBase {
   ...
   * The AI API service.
   *
   * @var \Drupal\agent_evaluation\Service\AIApiService
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('agent_evaluation.ai_api'),
  ...
  public function createConversation(Request $request) {
    ...
    try {
      ...
      \Drupal::logger('agent_evaluation_api')->error('Error creating conversation: @message', [
  ...
  public function sendMessage(Request $request, $conversation_id) {
    ...
    try {
      ...
      if (!$conversation || $conversation->bundle() !== 'agent_evaluation') {
        return new JsonResponse([
      ...
      \Drupal::logger('agent_evaluation_api')->error('Error sending message: @message', [
        '@message' => $e->getMessage(),
      ]);
  ...
  public function getHistory(Request $request, $conversation_id) {
    ...
    try {
      ...
      \Drupal::logger('agent_evaluation_api')->error('Error getting history: @message', [
        '@message' => $e->getMessage(),
      ]);
  ...
  public function getUserConversations(Request $request) {
    ...
    try {
      $query = \Drupal::entityQuery('node')
        ->condition('type', 'agent_evaluation')
      ...
      \Drupal::logger('agent_evaluation_api')->error('Error getting conversations: @message', [
        '@message' => $e->getMessage(),
      ]);
  ...
  public function deleteConversation(Request $request, $conversation_id) {
    ...
    try {
      ...
      \Drupal::logger('agent_evaluation_api')->error('Error deleting conversation: @message', [
        '@message' => $e->getMessage(),
      ]);
  ...
  public function getConversationStats(Request $request, $conversation_id) {
    ...
    try {
      ...
      \Drupal::logger('agent_evaluation_api')->error('Error getting stats: @message', [
        '@message' => $e->getMessage(),
      ]);

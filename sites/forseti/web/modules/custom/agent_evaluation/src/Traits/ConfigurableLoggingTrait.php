...
namespace Drupal\agent_evaluation\Traits;

/**
 * Trait for implementing controlled logging in agent_evaluation.
 * 
...
trait ConfigurableLoggingTrait {
  ...
  protected function getLogLevel(): int {
    ...
    $module_level = $config->get('modules.agent_evaluation.level');

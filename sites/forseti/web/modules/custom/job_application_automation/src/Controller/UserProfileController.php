...
class UserProfileController extends ControllerBase {
   ...
   *   The AI API service.
   */
  public function __construct(AccountInterface $current_user, EntityTypeManagerInterface $entity_type_manager, UserProfileService $user_profile_service, $ai_api_service = NULL) {

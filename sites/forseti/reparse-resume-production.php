 ...
 * 
 * This script bypasses development mode and forces a real GenAI extraction
 * of the resume to get comprehensive, detailed profile data instead of mock data.
 * 
 * Usage: php reparse-resume-production.php
 */
...
try {
  ...
  // ===================================================================
  // STEP 1: Load resume record with extracted text
  // ===================================================================
  ...
  // ===================================================================
  // STEP 2: Load file entity to get filename
  // ===================================================================
  echo "\nStep 2: Loading file entity...\n";
  
  $file_storage = \Drupal::entityTypeManager()->getStorage('file');
  $file = $file_storage->load($resume->file_id);
  ...
  // Core profile prompt (everything except professional_experience)
  $core_prompt = <<<PROMPT
...
2. Extract ALL skills from technical sections - do not limit to 4 per category
...
Return the JSON object with all core profile sections. Extract ALL skills and differentiators - do not limit to a small subset.
PROMPT;
...
Return the JSON object with professional_experience array containing ALL jobs and achievements with full details.
PROMPT;

  echo "Prompts prepared (core: " . strlen($core_prompt) . " chars, experience: " . strlen($experience_prompt) . " chars)\n";
  
  // ===================================================================
  // STEP 4: Call GenAI service for core profile
  // ===================================================================
  ...
  // Make the Bedrock API call for core profile
  $request_body = [
  ...
  // ===================================================================
  // STEP 5: Call GenAI service for professional experience
  // ===================================================================
  ...
  // ===================================================================
  // STEP 7: Update database with new parsed data
  // ===================================================================
  ...
  // ===================================================================
  // STEP 8: Update consolidated profile JSON
  // ===================================================================
  ...
  // For simplicity, replace the whole consolidated JSON with the new parsed data
  // In a production system you might want to merge intelligently
  ...
  echo "\nNext steps:\n";
  echo "  1. Clear Drupal cache: cd sites/forseti && ./vendor/bin/drush cr\n";

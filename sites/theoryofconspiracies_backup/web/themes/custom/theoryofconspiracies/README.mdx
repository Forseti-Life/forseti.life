# Theory of Conspiracies Theme

This custom theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS for the Theory of Conspiracies website.

...
resolve_drupal_root() {
  ...
  case "$SITE" in
    forseti|forseti.life|forseti-life)
      ...
      if [ -d "/home/keithaumiller/forseti.life/sites/forseti" ]; then printf '%s\n' "/home/keithaumiller/forseti.life/sites/forseti"; return 0; fi
      ;;
    dungeoncrawler|dungeoncrawler.forseti.life)
      ...
      if [ -d "/home/keithaumiller/forseti.life/sites/dungeoncrawler" ]; then printf '%s\n' "/home/keithaumiller/forseti.life/sites/dungeoncrawler"; return 0; fi
      ;;
  esac

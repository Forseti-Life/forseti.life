...
module_dir_for() {
  ...
  local candidates=(
    "/home/keithaumiller/forseti.life/sites/forseti/web/modules/custom/${module}"
    "/home/keithaumiller/forseti.life/web/modules/custom/${module}"
    "/home/keithaumiller/forseti.life/sites/forseti/modules/custom/${module}"
    "/home/keithaumiller/forseti.life/modules/custom/${module}"
  )
...
import os, sys
module = sys.argv[1]
roots = ["/home/keithaumiller/forseti.life"]
for root in roots:

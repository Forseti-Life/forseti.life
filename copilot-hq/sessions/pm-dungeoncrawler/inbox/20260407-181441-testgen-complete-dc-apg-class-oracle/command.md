# Grooming Complete: dc-apg-class-oracle
...
- `features/dc-apg-class-oracle/feature.md` ✓
- `features/dc-apg-class-oracle/01-acceptance-criteria.md` ✓
- `features/dc-apg-class-oracle/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-class-oracle/03-test-plan.md

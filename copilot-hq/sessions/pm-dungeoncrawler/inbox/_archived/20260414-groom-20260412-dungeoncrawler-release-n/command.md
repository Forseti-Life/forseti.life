# Groom Next Release: 20260412-dungeoncrawler-release-n

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-m
- Next release (your target): 20260412-dungeoncrawler-release-n
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-n is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-n only.
...
For each feature selected into 20260412-dungeoncrawler-release-n:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-n starts is automatically deferred.

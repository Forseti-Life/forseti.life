# Grooming Complete: dc-gmg-hazards
...
- `features/dc-gmg-hazards/feature.md` ✓
- `features/dc-gmg-hazards/01-acceptance-criteria.md` ✓
- `features/dc-gmg-hazards/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-gmg-hazards/03-test-plan.md

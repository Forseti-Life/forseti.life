...
Agent `dev-dungeoncrawler` has inbox item `20260414-203542-impl-dc-cr-halfling-heritage-hillock` with no matching outbox status artifact after `10585` seconds.

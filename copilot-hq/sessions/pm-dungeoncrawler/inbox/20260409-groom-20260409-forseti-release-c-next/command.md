# Groom Next Release: 20260409-forseti-release-c-next

- Site: dungeoncrawler
- Current release (Dev executing): 20260409-forseti-release-c
- Next release (your target): 20260409-forseti-release-c-next
...
- **Next release** — You groom the backlog so Stage 0 of 20260409-forseti-release-c-next is instant scope selection.

This task does NOT touch the current release. All work here is for 20260409-forseti-release-c-next only.
...
For each feature selected into 20260409-forseti-release-c-next:
```bash
...
Anything not groomed when Stage 0 of 20260409-forseti-release-c-next starts is automatically deferred.

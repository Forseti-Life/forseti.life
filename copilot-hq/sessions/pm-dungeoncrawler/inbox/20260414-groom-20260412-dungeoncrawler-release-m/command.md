# Groom Next Release: 20260412-dungeoncrawler-release-m

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-l
- Next release (your target): 20260412-dungeoncrawler-release-m
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-m is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-m only.
...
For each feature selected into 20260412-dungeoncrawler-release-m:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-m starts is automatically deferred.

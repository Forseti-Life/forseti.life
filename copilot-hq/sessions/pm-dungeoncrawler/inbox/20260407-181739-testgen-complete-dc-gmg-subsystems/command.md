# Grooming Complete: dc-gmg-subsystems
...
- `features/dc-gmg-subsystems/feature.md` ✓
- `features/dc-gmg-subsystems/01-acceptance-criteria.md` ✓
- `features/dc-gmg-subsystems/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-gmg-subsystems/03-test-plan.md

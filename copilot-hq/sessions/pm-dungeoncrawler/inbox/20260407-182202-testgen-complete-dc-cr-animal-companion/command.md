# Grooming Complete: dc-cr-animal-companion
...
- `features/dc-cr-animal-companion/feature.md` ✓
- `features/dc-cr-animal-companion/01-acceptance-criteria.md` ✓
- `features/dc-cr-animal-companion/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-animal-companion/03-test-plan.md

- Status: done
- Completed: 2026-04-12T03:25:46Z

# Groom Next Release: 20260412-dungeoncrawler-release-c

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-b
- Next release (your target): 20260412-dungeoncrawler-release-c
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-c is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-c only.
...
For each feature selected into 20260412-dungeoncrawler-release-c:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-c starts is automatically deferred.

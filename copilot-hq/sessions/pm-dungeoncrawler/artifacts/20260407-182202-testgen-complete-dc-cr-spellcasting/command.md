# Grooming Complete: dc-cr-spellcasting
...
- `features/dc-cr-spellcasting/feature.md` ✓
- `features/dc-cr-spellcasting/01-acceptance-criteria.md` ✓
- `features/dc-cr-spellcasting/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-spellcasting/03-test-plan.md

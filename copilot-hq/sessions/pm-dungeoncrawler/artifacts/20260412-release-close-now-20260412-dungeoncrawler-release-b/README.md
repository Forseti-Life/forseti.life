# Release close trigger: 20260412-dungeoncrawler-release-b

- Agent: pm-dungeoncrawler
- Release: 20260412-dungeoncrawler-release-b
- Status: pending
- Created: 2026-04-12T04:39:46.549913+00:00

## Auto-close conditions met
  - FEATURE_CAP: 10/10 features in_progress for dungeoncrawler release 20260412-dungeoncrawler-release-b
...
3. Write Release Notes to `sessions/pm-dungeoncrawler/artifacts/release-notes/20260412-dungeoncrawler-release-b.md`
4. Record your signoff: `./scripts/release-signoff.sh dungeoncrawler 20260412-dungeoncrawler-release-b`
5. Notify the partner PM to also sign off (coordinated release)

## Acceptance criteria
- `sessions/pm-dungeoncrawler/artifacts/release-signoffs/20260412-dungeoncrawler-release-b.md` exists with `- Status: approved`

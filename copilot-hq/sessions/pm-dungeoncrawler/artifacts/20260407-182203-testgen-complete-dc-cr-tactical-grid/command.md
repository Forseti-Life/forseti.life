# Grooming Complete: dc-cr-tactical-grid
...
- `features/dc-cr-tactical-grid/feature.md` ✓
- `features/dc-cr-tactical-grid/01-acceptance-criteria.md` ✓
- `features/dc-cr-tactical-grid/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-tactical-grid/03-test-plan.md

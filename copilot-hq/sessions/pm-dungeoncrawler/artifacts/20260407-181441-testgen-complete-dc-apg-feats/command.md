# Grooming Complete: dc-apg-feats
...
- `features/dc-apg-feats/01-acceptance-criteria.md` ✓
- `features/dc-apg-feats/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-feats/03-test-plan.md

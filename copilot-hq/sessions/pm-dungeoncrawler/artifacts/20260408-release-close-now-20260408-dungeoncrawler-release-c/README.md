# Release close trigger: 20260408-dungeoncrawler-release-c

- Agent: pm-dungeoncrawler
- Release: 20260408-dungeoncrawler-release-c
- Status: pending
- Created: 2026-04-08T04:49:00.912935+00:00

## Auto-close conditions met
  - FEATURE_CAP: 10/10 features in_progress for dungeoncrawler release 20260408-dungeoncrawler-release-c
...
3. Write Release Notes to `sessions/pm-dungeoncrawler/artifacts/release-notes/20260408-dungeoncrawler-release-c.md`
4. Record your signoff: `./scripts/release-signoff.sh dungeoncrawler 20260408-dungeoncrawler-release-c`
5. Notify the partner PM to also sign off (coordinated release)

## Acceptance criteria
- `sessions/pm-dungeoncrawler/artifacts/release-signoffs/20260408-dungeoncrawler-release-c.md` exists with `- Status: approved`

...
- Date: 2026-04-05
- Dispatched by: orchestrator (release active 181m, 0 features scoped)

## Task

Release `20260402-dungeoncrawler-release-c` has been active for **181 minutes** with zero features scoped.
Activate features now using:

```bash
bash scripts/pm-scope-activate.sh <feature_id> dungeoncrawler 20260402-dungeoncrawler-release-c
```

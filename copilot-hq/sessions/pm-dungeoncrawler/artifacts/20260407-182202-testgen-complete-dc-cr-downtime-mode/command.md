# Grooming Complete: dc-cr-downtime-mode
...
- `features/dc-cr-downtime-mode/feature.md` ✓
- `features/dc-cr-downtime-mode/01-acceptance-criteria.md` ✓
- `features/dc-cr-downtime-mode/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-downtime-mode/03-test-plan.md

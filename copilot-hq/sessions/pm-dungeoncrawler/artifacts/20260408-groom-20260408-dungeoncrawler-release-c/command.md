# Groom Next Release: 20260408-dungeoncrawler-release-c

- Site: dungeoncrawler
- Current release (Dev executing): 20260408-dungeoncrawler-release-b
- Next release (your target): 20260408-dungeoncrawler-release-c
...
- **Next release** — You groom the backlog so Stage 0 of 20260408-dungeoncrawler-release-c is instant scope selection.

This task does NOT touch the current release. All work here is for 20260408-dungeoncrawler-release-c only.
...
For each feature selected into 20260408-dungeoncrawler-release-c:
```bash
...
Anything not groomed when Stage 0 of 20260408-dungeoncrawler-release-c starts is automatically deferred.

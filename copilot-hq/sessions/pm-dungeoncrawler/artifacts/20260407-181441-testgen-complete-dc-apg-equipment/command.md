# Grooming Complete: dc-apg-equipment
...
- `features/dc-apg-equipment/feature.md` ✓
- `features/dc-apg-equipment/01-acceptance-criteria.md` ✓
- `features/dc-apg-equipment/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-equipment/03-test-plan.md

# Grooming Complete: dc-apg-class-witch
...
- `features/dc-apg-class-witch/feature.md` ✓
- `features/dc-apg-class-witch/01-acceptance-criteria.md` ✓
- `features/dc-apg-class-witch/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-class-witch/03-test-plan.md

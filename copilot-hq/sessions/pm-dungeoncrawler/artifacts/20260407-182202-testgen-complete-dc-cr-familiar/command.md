# Grooming Complete: dc-cr-familiar
...
- `features/dc-cr-familiar/feature.md` ✓
- `features/dc-cr-familiar/01-acceptance-criteria.md` ✓
- `features/dc-cr-familiar/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-familiar/03-test-plan.md

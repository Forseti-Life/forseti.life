# Groom Next Release: 20260322-dungeoncrawler-release-next

- Site: dungeoncrawler
- Current release (Dev executing): 20260322-dungeoncrawler-release
- Next release (your target): 20260322-dungeoncrawler-release-next
...
- **Next release** — You groom the backlog so Stage 0 of 20260322-dungeoncrawler-release-next is instant scope selection.

This task does NOT touch the current release. All work here is for 20260322-dungeoncrawler-release-next only.
...
For each feature selected into 20260322-dungeoncrawler-release-next:
```bash
...
Anything not groomed when Stage 0 of 20260322-dungeoncrawler-release-next starts is automatically deferred.

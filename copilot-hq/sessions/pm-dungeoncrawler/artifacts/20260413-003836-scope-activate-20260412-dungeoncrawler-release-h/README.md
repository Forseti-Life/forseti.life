# Scope Activate: 20260412-dungeoncrawler-release-h
...
Release `20260412-dungeoncrawler-release-h` has been active for **16 minutes** with zero features scoped.
...
- `dc-cr-animal-accomplice`
- `dc-cr-burrow-elocutionist`
- `dc-cr-first-world-adept`

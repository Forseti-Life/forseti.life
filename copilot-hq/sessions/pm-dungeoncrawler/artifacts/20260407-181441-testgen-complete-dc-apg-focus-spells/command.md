# Grooming Complete: dc-apg-focus-spells
...
- `features/dc-apg-focus-spells/feature.md` ✓
- `features/dc-apg-focus-spells/01-acceptance-criteria.md` ✓
- `features/dc-apg-focus-spells/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-focus-spells/03-test-plan.md

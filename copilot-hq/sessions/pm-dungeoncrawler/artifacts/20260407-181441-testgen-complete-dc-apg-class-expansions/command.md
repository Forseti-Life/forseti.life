# Grooming Complete: dc-apg-class-expansions
...
- `features/dc-apg-class-expansions/feature.md` ✓
- `features/dc-apg-class-expansions/01-acceptance-criteria.md` ✓
- `features/dc-apg-class-expansions/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-class-expansions/03-test-plan.md

# Groom Next Release: 20260409-dungeoncrawler-release-e

- Site: dungeoncrawler
- Current release (Dev executing): 20260409-dungeoncrawler-release-d
- Next release (your target): 20260409-dungeoncrawler-release-e
...
- **Next release** — You groom the backlog so Stage 0 of 20260409-dungeoncrawler-release-e is instant scope selection.

This task does NOT touch the current release. All work here is for 20260409-dungeoncrawler-release-e only.
...
For each feature selected into 20260409-dungeoncrawler-release-e:
```bash
...
Anything not groomed when Stage 0 of 20260409-dungeoncrawler-release-e starts is automatically deferred.

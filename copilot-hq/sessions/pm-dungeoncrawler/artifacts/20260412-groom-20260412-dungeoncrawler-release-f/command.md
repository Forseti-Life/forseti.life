- Status: done
- Completed: 2026-04-12T18:16:01Z

# Groom Next Release: 20260412-dungeoncrawler-release-f

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-e
- Next release (your target): 20260412-dungeoncrawler-release-f
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-f is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-f only.
...
For each feature selected into 20260412-dungeoncrawler-release-f:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-f starts is automatically deferred.

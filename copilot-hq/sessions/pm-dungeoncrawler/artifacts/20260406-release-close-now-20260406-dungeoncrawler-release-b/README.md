# Release close trigger: 20260406-dungeoncrawler-release-b

- Agent: pm-dungeoncrawler
- Release: 20260406-dungeoncrawler-release-b
- Status: pending
- Created: 2026-04-06T02:25:15.721894+00:00

## Auto-close conditions met
  - FEATURE_CAP: 11/10 features in_progress for dungeoncrawler
...
3. Write Release Notes to `sessions/pm-dungeoncrawler/artifacts/release-notes/20260406-dungeoncrawler-release-b.md`
4. Record your signoff: `./scripts/release-signoff.sh dungeoncrawler 20260406-dungeoncrawler-release-b`
5. Notify the partner PM to also sign off (coordinated release)

## Acceptance criteria
- `sessions/pm-dungeoncrawler/artifacts/release-signoffs/20260406-dungeoncrawler-release-b.md` exists with `- Status: approved`

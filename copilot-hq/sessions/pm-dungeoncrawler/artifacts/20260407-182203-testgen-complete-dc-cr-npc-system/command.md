# Grooming Complete: dc-cr-npc-system
...
- `features/dc-cr-npc-system/feature.md` ✓
- `features/dc-cr-npc-system/01-acceptance-criteria.md` ✓
- `features/dc-cr-npc-system/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-npc-system/03-test-plan.md

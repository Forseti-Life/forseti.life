# Grooming Complete: dc-cr-session-structure
...
- `features/dc-cr-session-structure/feature.md` ✓
- `features/dc-cr-session-structure/01-acceptance-criteria.md` ✓
- `features/dc-cr-session-structure/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-session-structure/03-test-plan.md

# Scope Activate: 20260409-dungeoncrawler-release-f

- Agent: pm-dungeoncrawler
- Status: pending
- Release: 20260409-dungeoncrawler-release-f
- Date: 2026-04-09
- Dispatched by: orchestrator (release active 29m, 0 features scoped)

## Task

Release `20260409-dungeoncrawler-release-f` has been active for **29 minutes** with zero features scoped.
...
- `dc-apg-spells`
- `dc-b1-bestiary1`
- `dc-cr-animal-companion`
- `dc-cr-class-alchemist`
- `dc-cr-class-barbarian`
- `dc-cr-class-bard`
- `dc-cr-class-cleric`
- `dc-cr-class-druid`

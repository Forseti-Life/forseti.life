# Release close trigger: 20260411-coordinated-release-next

- Agent: pm-dungeoncrawler
- Release: 20260411-coordinated-release-next
- Status: pending
- Created: 2026-04-12T00:37:26.463811+00:00

## Auto-close conditions met
  - FEATURE_CAP: 10/10 features in_progress for dungeoncrawler release 20260411-coordinated-release-next
...
3. Write Release Notes to `sessions/pm-dungeoncrawler/artifacts/release-notes/20260411-coordinated-release-next.md`
4. Record your signoff: `./scripts/release-signoff.sh dungeoncrawler 20260411-coordinated-release-next`
5. Notify the partner PM to also sign off (coordinated release)

## Acceptance criteria
- `sessions/pm-dungeoncrawler/artifacts/release-signoffs/20260411-coordinated-release-next.md` exists with `- Status: approved`

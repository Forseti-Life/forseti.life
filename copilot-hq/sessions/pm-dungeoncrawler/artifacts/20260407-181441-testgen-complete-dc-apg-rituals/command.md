# Grooming Complete: dc-apg-rituals
...
- `features/dc-apg-rituals/feature.md` ✓
- `features/dc-apg-rituals/01-acceptance-criteria.md` ✓
- `features/dc-apg-rituals/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-apg-rituals/03-test-plan.md

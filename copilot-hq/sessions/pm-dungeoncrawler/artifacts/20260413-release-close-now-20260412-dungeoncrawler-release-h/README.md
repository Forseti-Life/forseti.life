# Release close trigger: 20260412-dungeoncrawler-release-h

- Agent: pm-dungeoncrawler
- Release: 20260412-dungeoncrawler-release-h
- Status: pending
- Created: 2026-04-13T00:48:14.891709+00:00

## Auto-close conditions met
  - FEATURE_CAP: 10/10 features in_progress for dungeoncrawler release 20260412-dungeoncrawler-release-h
...
3. Write Release Notes to `sessions/pm-dungeoncrawler/artifacts/release-notes/20260412-dungeoncrawler-release-h.md`
4. Record your signoff: `./scripts/release-signoff.sh dungeoncrawler 20260412-dungeoncrawler-release-h`
5. Notify the partner PM to also sign off (coordinated release)

## Acceptance criteria
- `sessions/pm-dungeoncrawler/artifacts/release-signoffs/20260412-dungeoncrawler-release-h.md` exists with `- Status: approved`

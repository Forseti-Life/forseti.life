- Status: done
- Completed: 2026-04-11T03:18:17Z

# Groom Next Release: 20260411-dungeoncrawler-release-b

- Site: dungeoncrawler
- Current release (Dev executing): 20260410-dungeoncrawler-release-e
- Next release (your target): 20260411-dungeoncrawler-release-b
...
- **Next release** — You groom the backlog so Stage 0 of 20260411-dungeoncrawler-release-b is instant scope selection.

This task does NOT touch the current release. All work here is for 20260411-dungeoncrawler-release-b only.
...
For each feature selected into 20260411-dungeoncrawler-release-b:
```bash
...
Anything not groomed when Stage 0 of 20260411-dungeoncrawler-release-b starts is automatically deferred.

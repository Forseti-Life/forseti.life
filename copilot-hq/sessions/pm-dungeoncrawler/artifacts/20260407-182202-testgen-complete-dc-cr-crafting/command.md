# Grooming Complete: dc-cr-crafting
...
- `features/dc-cr-crafting/feature.md` ✓
- `features/dc-cr-crafting/01-acceptance-criteria.md` ✓
- `features/dc-cr-crafting/03-test-plan.md` ✓
...
If you want to review the test plan:
  cat features/dc-cr-crafting/03-test-plan.md

# Groom Next Release: 20260425-forseti-jobhunter-automation-release-b

- Site: forseti.life
- Current release (Dev executing): 20260425-forseti-jobhunter-automation-release-a
- Next release (your target): 20260425-forseti-jobhunter-automation-release-b
...
- **Next release** — You groom the backlog so Stage 0 of 20260425-forseti-jobhunter-automation-release-b is instant scope selection.

This task does NOT touch the current release. All work here is for 20260425-forseti-jobhunter-automation-release-b only.

## Steps

### 1. Pull community suggestions
```bash
./scripts/suggestion-intake.sh forseti-jobhunter-automation
```

### 2. Triage each suggestion
```bash
./scripts/suggestion-triage.sh forseti-jobhunter-automation <nid> accept <feature-id>
./scripts/suggestion-triage.sh forseti-jobhunter-automation <nid> defer
./scripts/suggestion-triage.sh forseti-jobhunter-automation <nid> decline
./scripts/suggestion-triage.sh forseti-jobhunter-automation <nid> escalate
```
...
```bash
./scripts/pm-qa-handoff.sh forseti-jobhunter-automation <feature-id>
```
...
For each feature selected into 20260425-forseti-jobhunter-automation-release-b:
```bash
./scripts/pm-scope-activate.sh forseti-jobhunter-automation <feature-id>
```
...
Anything not groomed when Stage 0 of 20260425-forseti-jobhunter-automation-release-b starts is automatically deferred.

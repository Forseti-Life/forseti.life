# Implementation required: forseti-langgraph-console-run-session
...
## Action required
1. Review feature brief: `features/forseti-langgraph-console-run-session/feature.md`
2. Review acceptance criteria: `features/forseti-langgraph-console-run-session/01-acceptance-criteria.md`

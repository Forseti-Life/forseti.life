...
Summary: 188 tracked local change(s), 187 untracked file(s)
...
Tracked change: copilot-hq/sessions/agent-code-review/inbox/20260419-code-review-dungeoncrawler-20260412-dungeoncrawler-release-n/command.md
...
Additional tracked changes: 168
Additional untracked files: 167
```

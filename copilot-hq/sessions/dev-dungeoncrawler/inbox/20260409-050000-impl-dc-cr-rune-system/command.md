...
Implement the dc-cr-rune-system feature for DungeonCrawler.

**Feature spec:** `features/dc-cr-rune-system/feature.md`
**Acceptance criteria:** `features/dc-cr-rune-system/01-acceptance-criteria.md`
**Test plan (for reference):** `features/dc-cr-rune-system/03-test-plan.md`

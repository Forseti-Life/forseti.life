# Implement: dc-cr-character-class
...
## Required action
Implement the feature per acceptance criteria in `features/dc-cr-character-class/01-acceptance-criteria.md` and test plan in `features/dc-cr-character-class/03-test-plan.md`.

## Acceptance criteria
See: `features/dc-cr-character-class/01-acceptance-criteria.md`

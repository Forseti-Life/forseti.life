# Implementation required: dc-cr-first-world-magic
...
## Action required
1. Review feature brief: `features/dc-cr-first-world-magic/feature.md`
2. Review acceptance criteria: `features/dc-cr-first-world-magic/01-acceptance-criteria.md`

# Implementation required: dc-gmg-running-guide
...
## Action required
1. Review feature brief: `features/dc-gmg-running-guide/feature.md`
2. Review acceptance criteria: `features/dc-gmg-running-guide/01-acceptance-criteria.md`

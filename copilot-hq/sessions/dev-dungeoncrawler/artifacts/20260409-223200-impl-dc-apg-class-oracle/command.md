...
- Feature file: features/dc-apg-class-oracle/feature.md

## Task
Implement Oracle class mechanics: Mystery, Curse of the Oracles (minor/moderate/major), Focus spells, and Revelation spells.
...
## Verification
- `drush sql-query` returns > 0 rows for Oracle content

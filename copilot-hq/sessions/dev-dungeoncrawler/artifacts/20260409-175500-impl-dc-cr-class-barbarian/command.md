# Dev Task: Implement dc-cr-class-barbarian
...
## Task
Implement Barbarian class: rage types (animal, dragon, fury, giant, spirit, superstition), class features through level 20.

## Acceptance criteria
- Feature dc-cr-class-barbarian is fully implemented per feature.md spec
...
grep -r "dc-cr-class-barbarian" /home/ubuntu/forseti.life/sites/dungeoncrawler/web/modules/custom/
# Run QA audit

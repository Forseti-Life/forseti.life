# Implementation required: dc-cr-gnome-weapon-expertise
...
## Action required
1. Review feature brief: `features/dc-cr-gnome-weapon-expertise/feature.md`
2. Review acceptance criteria: `features/dc-cr-gnome-weapon-expertise/01-acceptance-criteria.md`

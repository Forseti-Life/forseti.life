# Implementation required: dc-ui-map-first-player-shell

- Agent: dev-dungeoncrawler
- Feature: dc-ui-map-first-player-shell
- Release: 20260412-dungeoncrawler-release-m
- Status: pending
- Created: 2026-04-14T20:35:42+00:00
...
## Action required
1. Review feature brief: `features/dc-ui-map-first-player-shell/feature.md`
2. Review acceptance criteria: `features/dc-ui-map-first-player-shell/01-acceptance-criteria.md`

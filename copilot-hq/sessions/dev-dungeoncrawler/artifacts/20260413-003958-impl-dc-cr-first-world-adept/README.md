# Implementation required: dc-cr-first-world-adept
...
## Action required
1. Review feature brief: `features/dc-cr-first-world-adept/feature.md`
2. Review acceptance criteria: `features/dc-cr-first-world-adept/01-acceptance-criteria.md`

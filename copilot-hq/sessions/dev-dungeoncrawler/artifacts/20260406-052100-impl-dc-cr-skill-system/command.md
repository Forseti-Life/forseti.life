...
## Required action
Implement the feature per acceptance criteria in `features/dc-cr-skill-system/01-acceptance-criteria.md` and test plan in `features/dc-cr-skill-system/03-test-plan.md`.

## Acceptance criteria
See: `features/dc-cr-skill-system/01-acceptance-criteria.md`

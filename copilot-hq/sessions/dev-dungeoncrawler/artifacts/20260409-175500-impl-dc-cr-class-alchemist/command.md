# Dev Task: Implement dc-cr-class-alchemist
...
## Task
Implement Alchemist class: infusions, Quick Alchemy, versatile vials, class features through level 20.

## Acceptance criteria
- Feature dc-cr-class-alchemist is fully implemented per feature.md spec
...
grep -r "dc-cr-class-alchemist" /home/ubuntu/forseti.life/sites/dungeoncrawler/web/modules/custom/
# Run QA audit

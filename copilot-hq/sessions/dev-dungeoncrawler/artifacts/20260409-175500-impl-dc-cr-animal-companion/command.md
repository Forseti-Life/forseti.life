# Dev Task: Implement dc-cr-animal-companion
...
## Task
Implement Animal Companion rules: base companion stat blocks, mature/nimble/savage upgrades, companion specializations, mount rules.

## Acceptance criteria
- Feature dc-cr-animal-companion is fully implemented per feature.md spec
...
grep -r "dc-cr-animal-companion" /home/ubuntu/forseti.life/sites/dungeoncrawler/web/modules/custom/
# Run QA audit

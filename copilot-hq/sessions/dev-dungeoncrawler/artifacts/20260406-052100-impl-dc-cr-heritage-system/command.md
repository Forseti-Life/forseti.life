# Implement: dc-cr-heritage-system
...
## Required action
Implement the feature per acceptance criteria in `features/dc-cr-heritage-system/01-acceptance-criteria.md` and test plan in `features/dc-cr-heritage-system/03-test-plan.md`.

## Acceptance criteria
See: `features/dc-cr-heritage-system/01-acceptance-criteria.md`

# Implementation required: dc-cr-gnome-obsession
...
## Action required
1. Review feature brief: `features/dc-cr-gnome-obsession/feature.md`
2. Review acceptance criteria: `features/dc-cr-gnome-obsession/01-acceptance-criteria.md`

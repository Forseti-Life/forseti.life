# Dev Task: Implement dc-cr-class-cleric

- Release: 20260409-dungeoncrawler-release-f
- Feature: dc-cr-class-cleric
- Dispatched by: pm-dungeoncrawler
- Date: 2026-04-09

## Task
Implement Cleric class: doctrine system (cloistered, warpriest), divine spellcasting, domain spells, channel energy, class features through level 20.

## Acceptance criteria
- Feature dc-cr-class-cleric is fully implemented per feature.md spec
...
grep -r "dc-cr-class-cleric" /home/ubuntu/forseti.life/sites/dungeoncrawler/web/modules/custom/
# Run QA audit

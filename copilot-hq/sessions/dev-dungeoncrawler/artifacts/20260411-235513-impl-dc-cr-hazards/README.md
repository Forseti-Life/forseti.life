# Implementation required: dc-cr-hazards
...
## Action required
1. Review feature brief: `features/dc-cr-hazards/feature.md`
2. Review acceptance criteria: `features/dc-cr-hazards/01-acceptance-criteria.md`

# Implementation required: dc-cr-goblin-ancestry
...
## Action required
1. Review feature brief: `features/dc-cr-goblin-ancestry/feature.md`
2. Review acceptance criteria: `features/dc-cr-goblin-ancestry/01-acceptance-criteria.md`

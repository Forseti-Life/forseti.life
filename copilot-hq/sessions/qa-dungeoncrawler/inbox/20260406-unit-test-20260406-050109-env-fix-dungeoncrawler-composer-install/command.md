- command: |
    ...
    - Completed item: 20260406-050109-env-fix-dungeoncrawler-composer-install
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260406-050109-env-fix-dungeoncrawler-composer-install.md

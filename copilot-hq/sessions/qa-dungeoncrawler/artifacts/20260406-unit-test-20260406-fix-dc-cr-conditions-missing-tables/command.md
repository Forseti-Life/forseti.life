- command: |
    ...
    - Completed item: 20260406-fix-dc-cr-conditions-missing-tables
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260406-fix-dc-cr-conditions-missing-tables.md

- command: |
    ...
    - Completed item: 20260408-144600-impl-dc-cr-session-structure
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260408-144600-impl-dc-cr-session-structure.md

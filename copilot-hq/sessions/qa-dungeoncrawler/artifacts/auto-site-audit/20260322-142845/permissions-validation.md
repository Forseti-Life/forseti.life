...
- Roles run: anon, authenticated, content_editor, administrator, dc_playwright_player, dc_playwright_admin
- Violations: 0
- Probe issues: 60
...
| dc_playwright_player | route | 0 | /admin/reports/genai-debug/1/delete | http://localhost:8080/admin/reports/genai-debug/1/delete |
| dc_playwright_player | route | 0 | /admin/reports/genai-debug/delete-all | http://localhost:8080/admin/reports/genai-debug/delete-all |
| dc_playwright_player | route | 0 | /characters/create/step/1/save | http://localhost:8080/characters/create/step/1/save |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/import-open-issues/reconcile/start | http://localhost:8080/dungeoncrawler/testing/import-open-issues/reconcile/start |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/import-open-issues/reconcile/tick | http://localhost:8080/dungeoncrawler/testing/import-open-issues/reconcile/tick |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/import-open-issues/issue-pr-report/dead-value-close | http://localhost:8080/dungeoncrawler/testing/import-open-issues/issue-pr-report/dead-value-close |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/import-open-issues/issue-pr-report/bulk-close-query-run | http://localhost:8080/dungeoncrawler/testing/import-open-issues/issue-pr-report/bulk-close-query-run |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/queue/run | http://localhost:8080/dungeoncrawler/testing/queue/run |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/queue/item/delete | http://localhost:8080/dungeoncrawler/testing/queue/item/delete |
| dc_playwright_player | route | 0 | /dungeoncrawler/testing/queue/item/rerun | http://localhost:8080/dungeoncrawler/testing/queue/item/rerun |
| dc_playwright_admin | route | 0 | /admin/reports/genai-debug/1/delete | http://localhost:8080/admin/reports/genai-debug/1/delete |
| dc_playwright_admin | route | 0 | /admin/reports/genai-debug/delete-all | http://localhost:8080/admin/reports/genai-debug/delete-all |
| dc_playwright_admin | route | 0 | /characters/create/step/1/save | http://localhost:8080/characters/create/step/1/save |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/import-open-issues/reconcile/start | http://localhost:8080/dungeoncrawler/testing/import-open-issues/reconcile/start |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/import-open-issues/reconcile/tick | http://localhost:8080/dungeoncrawler/testing/import-open-issues/reconcile/tick |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/import-open-issues/issue-pr-report/dead-value-close | http://localhost:8080/dungeoncrawler/testing/import-open-issues/issue-pr-report/dead-value-close |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/import-open-issues/issue-pr-report/bulk-close-query-run | http://localhost:8080/dungeoncrawler/testing/import-open-issues/issue-pr-report/bulk-close-query-run |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/queue/run | http://localhost:8080/dungeoncrawler/testing/queue/run |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/queue/item/delete | http://localhost:8080/dungeoncrawler/testing/queue/item/delete |
| dc_playwright_admin | route | 0 | /dungeoncrawler/testing/queue/item/rerun | http://localhost:8080/dungeoncrawler/testing/queue/item/rerun |

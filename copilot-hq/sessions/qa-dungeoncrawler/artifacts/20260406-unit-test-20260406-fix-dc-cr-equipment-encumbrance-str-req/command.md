- command: |
    ...
    - Completed item: 20260406-fix-dc-cr-equipment-encumbrance-str-req
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260406-fix-dc-cr-equipment-encumbrance-str-req.md

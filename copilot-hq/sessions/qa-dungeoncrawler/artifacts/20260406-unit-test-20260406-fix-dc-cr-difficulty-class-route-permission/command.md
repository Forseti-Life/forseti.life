- command: |
    ...
    - Completed item: 20260406-fix-dc-cr-difficulty-class-route-permission
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260406-fix-dc-cr-difficulty-class-route-permission.md

- Status: done
- Completed: 2026-04-12T02:47:59Z
...
1. **Add a suite entry to** `qa-suites/products/dungeoncrawler/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "dc-cr-magic-ch11"`**  
   This links the test to the living requirements doc at `features/dc-cr-magic-ch11/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "dc-cr-magic-ch11-e2e",
     "label": "<describe what the test verifies>",
     "type": "e2e",
     "feature_id": "dc-cr-magic-ch11",
...
2. **Add permission rules to** `org-chart/sites/dungeoncrawler.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "dc-cr-magic-ch11"`**  
   Example:
   ```json
   {
     "id": "dc-cr-magic-ch11-<route-slug>",
     "feature_id": "dc-cr-magic-ch11",
     "path_regex": "/your-new-route",
     "notes": "Added for feature dc-cr-magic-ch11",

- command: |
    ...
    - Completed item: 20260409-bug-views-orphaned-field-character
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260409-bug-views-orphaned-field-character.md

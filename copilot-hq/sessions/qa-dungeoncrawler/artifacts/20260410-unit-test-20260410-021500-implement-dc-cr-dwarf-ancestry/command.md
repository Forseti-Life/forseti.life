- command: |
    ...
    - Completed item: 20260410-021500-implement-dc-cr-dwarf-ancestry
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260410-021500-implement-dc-cr-dwarf-ancestry.md

...
1. **Add a suite entry to** `qa-suites/products/dungeoncrawler/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "dc-cr-equipment-ch06"`**  
   This links the test to the living requirements doc at `features/dc-cr-equipment-ch06/`.  
   ...
   ```json
   {
     ...
     "type": "e2e",
     "feature_id": "dc-cr-equipment-ch06",
...
2. **Add permission rules to** `org-chart/sites/dungeoncrawler.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "dc-cr-equipment-ch06"`**  
   Example:
   ```json
   {
     "id": "dc-cr-equipment-ch06-<route-slug>",
     "feature_id": "dc-cr-equipment-ch06",
     "path_regex": "/your-new-route",
     "notes": "Added for feature dc-cr-equipment-ch06",

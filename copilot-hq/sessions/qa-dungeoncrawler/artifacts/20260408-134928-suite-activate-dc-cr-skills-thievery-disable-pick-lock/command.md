# Suite Activation: dc-cr-skills-thievery-disable-pick-lock
...
1. **Add a suite entry to** `qa-suites/products/dungeoncrawler/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "dc-cr-skills-thievery-disable-pick-lock"`**  
   This links the test to the living requirements doc at `features/dc-cr-skills-thievery-disable-pick-lock/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "dc-cr-skills-thievery-disable-pick-lock-e2e",
...
2. **Add permission rules to** `org-chart/sites/dungeoncrawler.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "dc-cr-skills-thievery-disable-pick-lock"`**  
   Example:
   ```json
   {
     "id": "dc-cr-skills-thievery-disable-pick-lock-<route-slug>",
     "feature_id": "dc-cr-skills-thievery-disable-pick-lock",
     "path_regex": "/your-new-route",
     "notes": "Added for feature dc-cr-skills-thievery-disable-pick-lock",

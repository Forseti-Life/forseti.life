- Status: done
- Completed: 2026-04-11T02:49:56Z

# Suite Activation: dc-cr-skills-nature-command-animal
...
1. **Add a suite entry to** `qa-suites/products/dungeoncrawler/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "dc-cr-skills-nature-command-animal"`**  
   This links the test to the living requirements doc at `features/dc-cr-skills-nature-command-animal/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "dc-cr-skills-nature-command-animal-e2e",
     "label": "<describe what the test verifies>",
     "type": "e2e",
     "feature_id": "dc-cr-skills-nature-command-animal",
...
2. **Add permission rules to** `org-chart/sites/dungeoncrawler.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "dc-cr-skills-nature-command-animal"`**  
   Example:
   ```json
   {
     "id": "dc-cr-skills-nature-command-animal-<route-slug>",
     "feature_id": "dc-cr-skills-nature-command-animal",
     "path_regex": "/your-new-route",
     "notes": "Added for feature dc-cr-skills-nature-command-animal",

- command: |
    ...
    - Completed item: 20260406-cr-finding-api-send-message-method
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260406-cr-finding-api-send-message-method.md

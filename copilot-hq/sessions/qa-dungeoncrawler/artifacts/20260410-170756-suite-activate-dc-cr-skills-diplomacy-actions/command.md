...
1. **Add a suite entry to** `qa-suites/products/dungeoncrawler/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "dc-cr-skills-diplomacy-actions"`**  
   This links the test to the living requirements doc at `features/dc-cr-skills-diplomacy-actions/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "dc-cr-skills-diplomacy-actions-e2e",
     "label": "<describe what the test verifies>",
     "type": "e2e",
     "feature_id": "dc-cr-skills-diplomacy-actions",
...
2. **Add permission rules to** `org-chart/sites/dungeoncrawler.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "dc-cr-skills-diplomacy-actions"`**  
   Example:
   ```json
   {
     "id": "dc-cr-skills-diplomacy-actions-<route-slug>",
     "feature_id": "dc-cr-skills-diplomacy-actions",
     "path_regex": "/your-new-route",
     "notes": "Added for feature dc-cr-skills-diplomacy-actions",

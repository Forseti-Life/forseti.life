- command: |
    ...
    - Completed item: 20260422-fix-install-crons-qa-site-audit-allow-prod
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260422-fix-install-crons-qa-site-audit-allow-prod.md

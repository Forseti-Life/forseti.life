- command: |
    ...
    - Completed item: 20260408-061200-release-signoff-cross-team-qa-fix
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260408-061200-release-signoff-cross-team-qa-fix.md

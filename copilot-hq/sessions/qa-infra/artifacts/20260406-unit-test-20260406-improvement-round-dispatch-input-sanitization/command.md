- command: |
    ...
    - Completed item: 20260406-improvement-round-dispatch-input-sanitization
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260406-improvement-round-dispatch-input-sanitization.md

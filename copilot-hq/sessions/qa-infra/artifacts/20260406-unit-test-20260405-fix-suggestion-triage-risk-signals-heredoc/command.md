- command: |
    ...
    - Completed item: 20260405-fix-suggestion-triage-risk-signals-heredoc
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260405-fix-suggestion-triage-risk-signals-heredoc.md

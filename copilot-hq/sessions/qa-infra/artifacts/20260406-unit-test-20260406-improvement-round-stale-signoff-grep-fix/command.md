- command: |
    ...
    - Completed item: 20260406-improvement-round-stale-signoff-grep-fix
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260406-improvement-round-stale-signoff-grep-fix.md

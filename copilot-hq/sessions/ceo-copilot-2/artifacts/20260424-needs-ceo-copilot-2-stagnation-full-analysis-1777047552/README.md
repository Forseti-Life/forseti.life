...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T16:18:10.528512+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 35m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 2737m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 50h 2m (threshold 2h)
...
- pm-forseti: `20260416-sla-outbox-lag-dev-forseti-20260414-205816-impl-forseti-fin` (20m old)
- pm-forseti: `20260419-groom-20260412-forseti-release-n` (20m old)
- pm-forseti: `20260423-needs-dev-forseti-20260423-161501-qa-findings-forseti.life-1` (20m old)
- pm-forseti: `20260422-release-cleanup-forseti-orphans` (20m old)
- pm-forseti: `20260422-release-kpi-stagnation` (20m old)

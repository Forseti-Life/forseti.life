...
- Status: pending
- Supervisor: board
- Created: 2026-04-07T20:03:30.966140+00:00
...
## Signals fired (4):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 1080m old (threshold 30m)
  - BLOCKED_TICKS: 13 consecutive ticks with 1 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 26h 53m (threshold 2h)

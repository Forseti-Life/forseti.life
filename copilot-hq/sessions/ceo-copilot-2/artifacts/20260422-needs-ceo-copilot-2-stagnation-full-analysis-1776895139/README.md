...
- Status: pending
- Supervisor: board
- Created: 2026-04-22T21:57:06.444083+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 131m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 196m old (threshold 30m)
...
- agent-code-review: `20260419-code-review-forseti.life-20260412-forseti-release-m` (12m old)
- agent-code-review: `20260422-clarify-escalation-20260419-code-review-dungeoncrawler-20260412-dungeoncrawler-` (12m old)
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (9m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (9m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (9m old)
...
- pm-forseti: 20260417-post-push-20260412-dungeoncrawler-release-m.md [status=needs-info] [MALFORMED: needs-info with empty/N/A Needs section — CEO cleanup needed]
- dev-forseti: 20260422-171501-qa-findings-forseti-life-3.md [status=blocked]
  Blockers:

...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T18:01:37.257143+00:00
...
## Signals fired (4):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 85m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 1401m old (threshold 30m)
  - CEO_INBOX_DEPTH: 3 pending CEO inbox items (threshold 3)
  - NO_RELEASE_PROGRESS: no release signoff in 27h 45m (threshold 2h)
...
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (12m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (12m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (12m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-merge-health-remediation` (12m old)
- qa-infra: `20260422-ceo-escalation-5-stale-unit-tests` (12m old)
...
- pm-forseti: 20260414-groom-20260412-forseti-release-m.md [status=needs-info] [MALFORMED: needs-info with empty/N/A Needs section — CEO cleanup needed]

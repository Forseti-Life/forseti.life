...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T18:14:21.941474+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 152m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 2853m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 51h 58m (threshold 2h)
...
- pm-infra: `20260424-urgent-fix-production-forseti-dashboards-permissions` (8m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (8m old)
- dev-infra: `20260424-syshealth-executor-failures-prune` (8m old)

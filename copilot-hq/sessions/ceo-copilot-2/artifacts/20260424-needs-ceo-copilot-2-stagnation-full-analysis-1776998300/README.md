...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T02:15:21.437093+00:00
...
## Signals fired (2):
  - INBOX_AGING: oldest unresolved inbox item is 1894m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 35h 59m (threshold 2h)
...
- ceo-copilot-2: `20260424-sla-outbox-lag-pm-forseti-20260416-sla-dev-qa-forseti-stal` (7m old)
...
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (3m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (3m old)

...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T00:22:29.093978+00:00
...
## Signals fired (2):
  - INBOX_AGING: oldest unresolved inbox item is 1781m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 34h 6m (threshold 2h)
...
- dev-infra: `20260424-syshealth-executor-failures-prune` (16m old)
- pm-infra: `20260422-sla-outbox-lag-dev-infra-20260422-syshealth-orchestrator-` (2m old)
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (2m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (2m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (2m old)

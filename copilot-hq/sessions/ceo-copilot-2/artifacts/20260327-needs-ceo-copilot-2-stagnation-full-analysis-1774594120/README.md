...
- Status: pending
- Supervisor: board
- Created: 2026-03-27T06:47:34.094340+00:00
...
## Signals fired (4):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 2639m old (threshold 30m)
  - BLOCKED_TICKS: 14 consecutive ticks with 2 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 103h 30m (threshold 2h)

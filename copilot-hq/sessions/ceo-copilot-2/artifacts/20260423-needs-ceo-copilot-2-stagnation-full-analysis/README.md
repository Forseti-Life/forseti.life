...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T00:38:38.430872+00:00
...
## Signals fired (3):
  - INBOX_AGING: oldest unresolved inbox item is 358m old (threshold 30m)
  - CEO_INBOX_DEPTH: 4 pending CEO inbox items (threshold 3)
  - NO_RELEASE_PROGRESS: no release signoff in 10h 22m (threshold 2h)
...
- ceo-copilot-2: `20260422-needs-escalated-dev-forseti-20260422-191501-qa-findings-forseti-life-3` (19m old)
- ceo-copilot-2: `20260423-needs-ceo-copilot-2-auto-investigate-fix` (19m old)
- ceo-copilot-2: `20260422-needs-ceo-copilot-2-auto-investigate-fix` (19m old)
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (5m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (5m old)
...
- dev-forseti: 20260422-191501-qa-findings-forseti.life-3.md [status=blocked]
  Blockers:

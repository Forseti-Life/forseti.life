...
- Status: pending
- Supervisor: board
- Created: 2026-04-09T08:35:47.481929+00:00
...
## Signals fired (4):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 3272m old (threshold 30m)
  - BLOCKED_TICKS: 20 consecutive ticks with 1 blocked agent(s) and no resolution (threshold 5)
...
- pm-dungeoncrawler: `20260409-083417-scope-activate-20260409-dungeoncrawler-release-e` (1m old)

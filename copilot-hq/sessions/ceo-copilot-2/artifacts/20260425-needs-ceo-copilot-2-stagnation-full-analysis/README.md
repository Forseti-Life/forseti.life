...
- Status: pending
- Supervisor: board
- Created: 2026-04-25T00:41:36.160054+00:00
...
## Signals fired (2):
  - INBOX_AGING: oldest unresolved inbox item is 3241m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 58h 25m (threshold 2h)
...
- dev-infra: `20260425-syshealth-executor-failures-prune` (17m old)
- ceo-copilot-2: `20260425-syshealth-dead-letter-board-20260422-needs-ceo-copilot-2-20260422-board-escalation-production-outage-homepage-500` (3m old)
- pm-infra: `20260422-sla-outbox-lag-dev-infra-20260422-syshealth-orchestrator-` (3m old)
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (3m old)
- pm-infra: `20260424-urgent-fix-production-forseti-dashboards-permissions` (3m old)

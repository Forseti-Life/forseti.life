...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T17:38:45.700511+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 116m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 2818m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 51h 22m (threshold 2h)
...
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (10m old)
- pm-infra: `20260424-urgent-fix-production-forseti-dashboards-permissions` (10m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (10m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (10m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-merge-health-remediation` (10m old)
...
- qa-forseti: 20260423-rerun-full-audit-forseti.life-20260423-191501.md [status=needs-info] [MALFORMED: needs-info with empty/N/A Needs section — CEO cleanup needed]

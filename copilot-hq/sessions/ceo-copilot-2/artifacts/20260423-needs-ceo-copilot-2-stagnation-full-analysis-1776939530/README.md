...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T10:17:45.658676+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 90m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 937m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 20h 1m (threshold 2h)
...
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (7m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (7m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (7m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-merge-health-remediation` (7m old)
- qa-infra: `20260422-ceo-escalation-5-stale-unit-tests` (7m old)

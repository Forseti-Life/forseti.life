...
- Status: pending
- Supervisor: board
- Created: 2026-04-09T12:09:05.113707+00:00
...
## Signals fired (3):
  - INBOX_AGING: oldest unresolved inbox item is 3485m old (threshold 30m)
  - BLOCKED_TICKS: 20 consecutive ticks with 1 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 6h 4m (threshold 2h)
...
- pm-forseti: `20260409-120856-scope-activate-forseti-release-f-unblock` (0m old)

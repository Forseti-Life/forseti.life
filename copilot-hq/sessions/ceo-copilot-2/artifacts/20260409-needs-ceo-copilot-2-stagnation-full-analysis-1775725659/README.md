...
- Status: pending
- Supervisor: board
- Created: 2026-04-09T09:07:13.118373+00:00
...
## Signals fired (4):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 3303m old (threshold 30m)
  - BLOCKED_TICKS: 21 consecutive ticks with 1 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 3h 2m (threshold 2h)

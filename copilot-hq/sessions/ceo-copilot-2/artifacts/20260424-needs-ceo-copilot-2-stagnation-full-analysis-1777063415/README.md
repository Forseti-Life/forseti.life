...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T20:42:34.000933+00:00
...
## Signals fired (3):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 3001m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 54h 26m (threshold 2h)
...
- qa-forseti: `20260424-clarify-escalation-20260423-rerun-full-audit-forseti.life-20260423-191501` (9m old)
...
- pm-infra: `20260424-urgent-fix-production-forseti-dashboards-permissions` (0m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (0m old)

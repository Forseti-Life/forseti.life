...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T05:04:14.798753+00:00
...
## Signals fired (3):
  - INBOX_AGING: oldest unresolved inbox item is 623m old (threshold 30m)
  - CEO_INBOX_DEPTH: 3 pending CEO inbox items (threshold 3)
  - NO_RELEASE_PROGRESS: no release signoff in 14h 48m (threshold 2h)
...
- qa-forseti: `20260422-rerun-full-audit-forseti.life-20260422-231501` (9m old)
...
- dev-forseti: 20260423-001501-qa-findings-forseti.life-3.md [status=blocked]
  Blockers:

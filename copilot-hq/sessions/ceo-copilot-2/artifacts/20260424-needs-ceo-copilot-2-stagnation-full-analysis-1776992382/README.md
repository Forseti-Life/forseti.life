...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T00:58:40.546915+00:00
...
## Signals fired (2):
  - INBOX_AGING: oldest unresolved inbox item is 1818m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 34h 42m (threshold 2h)
...
- pm-infra: `20260422-sla-outbox-lag-qa-infra-20260417-unit-test-20260416-sysh` (6m old)
- pm-infra: `20260424-urgent-fix-production-forseti-dashboards-permissions` (6m old)
- pm-infra: `20260422-qa-infra-stagnation-8-pending-items` (6m old)
- qa-infra: `20260422-unit-test-20260422-fix-install-crons-qa-site-audit-allow-prod` (6m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-merge-health-remediation` (6m old)

...
- Status: pending
- Supervisor: board
- Created: 2026-04-25T14:16:37.374951+00:00
...
## Signals fired (4):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 254m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 4056m old (threshold 30m)
  - CEO_INBOX_DEPTH: 5 pending CEO inbox items (threshold 3)
  - NO_RELEASE_PROGRESS: no release signoff in 72h 0m (threshold 2h)
...
- pm-forseti: `20260416-sla-outbox-lag-dev-forseti-20260414-205816-impl-forseti-fin` (254m old)
- pm-forseti: `20260419-groom-20260412-forseti-release-n` (254m old)
- pm-forseti: `20260423-needs-dev-forseti-20260423-161501-qa-findings-forseti.life-1` (254m old)
- pm-forseti: `20260422-release-cleanup-forseti-orphans` (254m old)
- pm-forseti: `20260422-release-kpi-stagnation` (254m old)

...
- Status: pending
- Supervisor: board
- Created: 2026-04-25T12:22:24.035342+00:00
...
## Signals fired (4):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 3941m old (threshold 30m)
  - CEO_INBOX_DEPTH: 5 pending CEO inbox items (threshold 3)
  - NO_RELEASE_PROGRESS: no release signoff in 70h 6m (threshold 2h)

# Groom Next Release: 20260405-forseti-release-b

- Agent: pm-forseti
- Status: pending

- Site: forseti.life
- Current release (Dev executing): 20260402-forseti-release-b
- Next release (your target): 20260405-forseti-release-b
...
- **Next release** — You groom the backlog so Stage 0 of 20260405-forseti-release-b is instant scope selection.

This task does NOT touch the current release. All work here is for 20260405-forseti-release-b only.
...
For each feature selected into 20260405-forseti-release-b:
```bash
...
Anything not groomed when Stage 0 of 20260405-forseti-release-b starts is automatically deferred.

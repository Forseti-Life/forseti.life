# Push ready: 20260322-forseti-release

All required PM signoffs recorded for coordinated release `20260322-forseti-release`.
...
1. Verify: `bash scripts/release-signoff-status.sh 20260322-forseti-release`

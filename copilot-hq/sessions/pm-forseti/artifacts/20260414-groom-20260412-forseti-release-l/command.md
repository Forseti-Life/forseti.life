# Groom Next Release: 20260412-forseti-release-l

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-k
- Next release (your target): 20260412-forseti-release-l
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-l is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-l only.
...
For each feature selected into 20260412-forseti-release-l:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-l starts is automatically deferred.

...
- Findings summary: sessions/qa-forseti/artifacts/auto-site-audit/20260408-031455/findings-summary.md
...
2) If satisfied: run `bash scripts/release-signoff.sh forseti 20260408-forseti-release-b` to record your signoff.

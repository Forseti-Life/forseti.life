# Groom Next Release: 20260322-forseti-release-next

- Site: forseti.life
- Current release (Dev executing): 20260322-forseti-release
- Next release (your target): 20260322-forseti-release-next
...
- **Next release** — You groom the backlog so Stage 0 of 20260322-forseti-release-next is instant scope selection.

This task does NOT touch the current release. All work here is for 20260322-forseti-release-next only.
...
For each feature selected into 20260322-forseti-release-next:
```bash
...
Anything not groomed when Stage 0 of 20260322-forseti-release-next starts is automatically deferred.

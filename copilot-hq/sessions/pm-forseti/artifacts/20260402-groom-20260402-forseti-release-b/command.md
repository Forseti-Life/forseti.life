# Groom Next Release: 20260402-forseti-release-b

- Site: forseti.life
- Current release (Dev executing): 20260322-forseti-release-next
- Next release (your target): 20260402-forseti-release-b
...
- **Next release** — You groom the backlog so Stage 0 of 20260402-forseti-release-b is instant scope selection.

This task does NOT touch the current release. All work here is for 20260402-forseti-release-b only.
...
For each feature selected into 20260402-forseti-release-b:
```bash
...
Anything not groomed when Stage 0 of 20260402-forseti-release-b starts is automatically deferred.

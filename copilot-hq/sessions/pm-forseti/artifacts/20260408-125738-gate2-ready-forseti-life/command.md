...
- Findings summary: sessions/qa-forseti/artifacts/auto-site-audit/20260408-125738/findings-summary.md
...
2) If satisfied: run `bash scripts/release-signoff.sh forseti 20260408-forseti-release-d` to record your signoff.

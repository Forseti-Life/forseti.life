# Groom Next Release: 20260412-forseti-release-c

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-b
- Next release (your target): 20260412-forseti-release-c
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-c is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-c only.
...
For each feature selected into 20260412-forseti-release-c:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-c starts is automatically deferred.

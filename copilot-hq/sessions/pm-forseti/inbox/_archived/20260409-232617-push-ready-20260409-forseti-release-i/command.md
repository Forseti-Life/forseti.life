# Push ready: 20260409-forseti-release-i

All required PM signoffs recorded for coordinated release `20260409-forseti-release-i`.
...
1. Verify: `bash scripts/release-signoff-status.sh 20260409-forseti-release-i`

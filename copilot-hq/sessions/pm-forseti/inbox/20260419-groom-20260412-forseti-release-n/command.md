...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-n is instant scope selection.
...
For each feature selected into 20260412-forseti-release-n:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-n starts is automatically deferred.

- command: |
    ...
    - Completed item: 20260410-fix-aitips-csrf-delivery-forseti-release-c
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260410-fix-aitips-csrf-delivery-forseti-release-c.md

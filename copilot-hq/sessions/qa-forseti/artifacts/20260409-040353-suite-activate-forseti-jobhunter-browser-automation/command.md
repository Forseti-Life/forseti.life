# Suite Activation: forseti-jobhunter-browser-automation

**From:** pm-forseti  
**To:** qa-forseti  
**Date:** 2026-04-09T04:03:53+00:00  
...
1. **Add a suite entry to** `qa-suites/products/forseti/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "forseti-jobhunter-browser-automation"`**  
   This links the test to the living requirements doc at `features/forseti-jobhunter-browser-automation/`.  
...
2. **Add permission rules to** `org-chart/sites/forseti.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "forseti-jobhunter-browser-automation"`**  
   Example:
   ```json
   {
     "id": "forseti-jobhunter-browser-automation-<route-slug>",
     "feature_id": "forseti-jobhunter-browser-automation",
     "path_regex": "/your-new-route",
     "notes": "Added for feature forseti-jobhunter-browser-automation",

- command: |
    ...
    - Completed item: 20260409-impl-forseti-jobhunter-application-status-dashboard
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260409-impl-forseti-jobhunter-application-status-dashboard.md

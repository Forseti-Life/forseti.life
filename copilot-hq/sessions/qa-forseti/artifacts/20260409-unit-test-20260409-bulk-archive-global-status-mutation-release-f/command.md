- command: |
    ...
    - Completed item: 20260409-bulk-archive-global-status-mutation-release-f
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260409-bulk-archive-global-status-mutation-release-f.md

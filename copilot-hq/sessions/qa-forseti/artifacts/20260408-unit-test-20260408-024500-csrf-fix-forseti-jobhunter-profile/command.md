- command: |
    ...
    - Completed item: 20260408-024500-csrf-fix-forseti-jobhunter-profile
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260408-024500-csrf-fix-forseti-jobhunter-profile.md

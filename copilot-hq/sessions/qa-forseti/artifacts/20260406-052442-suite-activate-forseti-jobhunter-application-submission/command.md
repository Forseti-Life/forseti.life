# Suite Activation: forseti-jobhunter-application-submission

**From:** pm-forseti  
**To:** qa-forseti  
**Date:** 2026-04-06T05:24:42+00:00  
...
1. **Add a suite entry to** `qa-suites/products/forseti/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "forseti-jobhunter-application-submission"`**  
   This links the test to the living requirements doc at `features/forseti-jobhunter-application-submission/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "forseti-jobhunter-application-submission-e2e",
...
2. **Add permission rules to** `org-chart/sites/forseti.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "forseti-jobhunter-application-submission"`**  
   Example:
   ```json
   {
     "id": "forseti-jobhunter-application-submission-<route-slug>",
     "feature_id": "forseti-jobhunter-application-submission",
     "path_regex": "/your-new-route",
     "notes": "Added for feature forseti-jobhunter-application-submission",

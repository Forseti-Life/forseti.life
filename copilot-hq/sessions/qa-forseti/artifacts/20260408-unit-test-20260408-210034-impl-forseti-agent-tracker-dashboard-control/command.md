- command: |
    ...
    - Completed item: 20260408-210034-impl-forseti-agent-tracker-dashboard-controller-db-extraction
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260408-210034-impl-forseti-agent-tracker-dashboard-controller-db-extraction.md

- Status: done
- Completed: 2026-04-11T16:34:58Z

# Suite Activation: forseti-langgraph-console-release-panel
...
1. **Add a suite entry to** `qa-suites/products/forseti/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "forseti-langgraph-console-release-panel"`**  
   This links the test to the living requirements doc at `features/forseti-langgraph-console-release-panel/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "forseti-langgraph-console-release-panel-e2e",
     "label": "<describe what the test verifies>",
     "type": "e2e",
     "feature_id": "forseti-langgraph-console-release-panel",
...
2. **Add permission rules to** `org-chart/sites/forseti.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "forseti-langgraph-console-release-panel"`**  
   Example:
   ```json
   {
     "id": "forseti-langgraph-console-release-panel-<route-slug>",
     "feature_id": "forseti-langgraph-console-release-panel",
     "path_regex": "/your-new-route",
     "notes": "Added for feature forseti-langgraph-console-release-panel",

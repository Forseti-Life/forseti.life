- command: |
    ...
    - Completed item: 20260322-recover-impl-copilot-agent-tracker
    - Dev seat: dev-forseti-agent-tracker
    - Dev outbox: sessions/dev-forseti-agent-tracker/outbox/20260322-recover-impl-copilot-agent-tracker.md

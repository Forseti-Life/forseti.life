- command: |
    ...
    - Completed item: 20260409-cr-finding-bulk-archive-global-mutation
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260409-cr-finding-bulk-archive-global-mutation.md

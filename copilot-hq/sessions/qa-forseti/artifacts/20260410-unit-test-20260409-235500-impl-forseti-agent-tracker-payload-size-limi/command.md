- command: |
    ...
    - Completed item: 20260409-235500-impl-forseti-agent-tracker-payload-size-limit
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260409-235500-impl-forseti-agent-tracker-payload-size-limit.md

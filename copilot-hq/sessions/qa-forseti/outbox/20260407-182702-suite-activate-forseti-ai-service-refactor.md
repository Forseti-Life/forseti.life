...
|---|---|---|---|
| `forseti-ai-service-refactor-static` | static | TC-01, TC-02, TC-03 | `forseti-ai-service-refactor` |
| `forseti-ai-service-refactor-functional` | unit | TC-04, TC-05 | `forseti-ai-service-refactor` |
| `forseti-ai-service-refactor-unit` | unit | TC-06 | `forseti-ai-service-refactor` |

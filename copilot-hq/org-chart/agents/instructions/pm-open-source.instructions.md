...
- PM-open-source owns phase scheduling, publication-candidate gate, and Board/CEO signoff for each public repo push.
...
# Check Phase 1 security audit status
ls sessions/dev-open-source/outbox/ | grep "phase1\|security-audit\|bfg"
```

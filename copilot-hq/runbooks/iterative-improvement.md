...
- Every 2 hours: `scripts/ceo-ops-once.sh` runs the clean-audit Gate 2 backstop and, when it had to unblock a release itself, queues a CEO root-cause review item so the blocker becomes a permanent process fix.

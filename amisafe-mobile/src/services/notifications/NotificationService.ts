...
class NotificationService {
  ...
  private createNotificationChannels(): void {
    PushNotification.createChannel(
      {
        channelId: 'amisafe-safety-alerts',
    ...
    PushNotification.createChannel(
      {
        channelId: 'amisafe-general',
        channelName: 'General Notifications',
        channelDescription: 'General AmISafe notifications',
  ...
  private getChannelId(title: string): string {
    ...
    if (lowerTitle.includes('emergency') || lowerTitle.includes('urgent')) {
      return 'amisafe-emergency';
    }
    if (lowerTitle.includes('safety') || lowerTitle.includes('alert')) {
      return 'amisafe-safety-alerts';
    }
    return 'amisafe-general';
  }

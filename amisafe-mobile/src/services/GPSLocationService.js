/**
 * GPS Location Service for AmISafe Mobile Application
 * 
...
const STORAGE_KEYS = {
  LAST_LOCATION: 'amisafe_last_location',
  LOCATION_HISTORY: 'amisafe_location_history',
  PERMISSION_STATUS: 'amisafe_permission_status'
};

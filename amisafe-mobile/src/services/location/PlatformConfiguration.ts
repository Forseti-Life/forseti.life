...
3. CREATE BootReceiver.java (or .kt) in android/app/src/main/java/com/amisafe/:
   ...
   public class BootReceiver extends BroadcastReceiver {
       ...
       public void onReceive(Context context, Intent intent) {
           if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
               Log.d("AmISafe", "Boot completed - checking monitoring state");
...
4. CREATE LocationMonitoringService.java in android/app/src/main/java/com/amisafe/:
...
6. iOS CONFIGURATION (Info.plist):
   ...
   <string>AmISafe needs your location to alert you about dangerous areas</string>

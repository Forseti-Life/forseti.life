...
# Dungeon Crawler Production Server Setup Script
# Sets up dungeoncrawler.forseti.life as a Drupal 11 sub-site on the existing production server
...
# Configuration
SITE_NAME="dungeoncrawler"
DOMAIN_NAME="dungeoncrawler.forseti.life"
DRUPAL_ROOT="/var/www/html/dungeoncrawler"
DB_NAME="dungeoncrawler_prod"
DB_USER="drupal_user"
DB_PASSWORD="drupal_secure_password"
ADMIN_USER="admin"
ADMIN_PASSWORD="admin_secure_password"
ADMIN_EMAIL="admin@dungeoncrawler.forseti.life"
...
sudo -u www-data ./vendor/bin/drush site:install standard \
    ...
    --site-name="${DC_SITE_NAME:-Dungeon Crawler}" \
...
cd "$DRUPAL_ROOT"
print_status "Enabling essential modules..."
 ...
 * Hash salt
 */
$settings['hash_salt'] = file_get_contents('/var/www/html/dungeoncrawler/web/sites/default/salt.txt');

/**
 * Private file path
 */
$settings['file_private_path'] = '/var/private/dungeoncrawler';
EOF
...
mkdir -p /var/private/dungeoncrawler
chown -R www-data:www-data /var/private/dungeoncrawler
chmod -R 775 /var/private/dungeoncrawler
...
echo ""
echo "════════════════════════════════════════════════════════════════"
echo "🎉 DUNGEON CRAWLER PRODUCTION SETUP COMPLETED SUCCESSFULLY!"
echo "════════════════════════════════════════════════════════════════"
echo ""
echo "📋 Site Information:"
echo "  Site Name: Dungeon Crawler"
...
echo "  Private Files: /var/private/dungeoncrawler"
echo ""
...
echo ""
echo "🔧 Next Steps:"
echo "  1. Point DNS for ${DOMAIN_NAME} to this server (CNAME or A record)"
echo "  2. Configure SSL: certbot --apache -d ${DOMAIN_NAME}"
echo "  3. Push code to main branch to trigger deployment"
echo ""
echo "🚀 Dungeon Crawler is ready!"
echo "════════════════════════════════════════════════════════════════"
echo ""
